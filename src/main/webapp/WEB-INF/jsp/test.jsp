...
<div id="main">
    <h2 class="top_title"><a href="http://www.helloweba.net/javascript/278.html">在线选座订座（影院篇）</a></h2>
    <div class="demo">
        <div id="seat-map">
...
<%--<script type="text/javascript" src="<%=basePath%>static/js/my.js"></script>--%>
<script type='text/javascript' src="<%=basePath%>static/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<%=basePath%>static/js/jquery.seat-charts.min.js"></script>
