    ...
    <script>
        function del(id) {
          ...
          if (null != adminUserRoleStr && !"".endsWith(adminUserRoleStr) && "1".endsWith(adminUserRoleStr)) {
            ...
            if (confirm('您确定删除吗？')) {
                window.location.href = "card/delCard?id=" + id;
            }
        }

        function toEdit(id) {
            window.location.href = "card/toEditCard?id=" + id;
        }

        function toAdd() {
            window.location.href = "card/toAddCard";
        }
    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <button onclick="toAdd()">添加会员卡</button>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th width="10%">会员卡名称</th>
                                    <th width="10%">会员卡价格</th>
                                    <th width="50%">会员卡描述</th>
                                    <th width="10%">会员卡折扣</th>
                                    <th width="20%">操作</th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    ...
                                    <td><span>${cardList.name}</span></td>
                                    <td><span>${cardList.price}</span></td>
                                    <td><span>${cardList.carddesc}</span></td>
                                    <td><span>${cardList.discount}</span></td>

                                    <td>
                                        <div class="">
                                            <button class="green" onclick="toEdit(${cardList.id})">
                                                <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                编辑
                                            </button>

                                            <button class="red" onclick="del(${cardList.id})">
