                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="card/addCard"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" placeholder="会员卡名称" class=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="price" placeholder="会员卡价格" class=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="autosize-transition" id="carddesc" name="carddesc"
                                              cols="80"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
