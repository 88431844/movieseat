...
<head>
    ...
    <script>
        function edit() {
            var form = document.getElementById('cardInfo');
            form.submit();
        }
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="card/editCard"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="${cardInfo.name}" placeholder="会员卡名称"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 会员卡价格 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="director" value="${cardInfo.price}" placeholder="会员卡价格"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="discount"> 会员卡折扣 </label>
                            ...
                            <input type="hidden" name="oldName" value="${cardInfo.name}">
                        </form>
