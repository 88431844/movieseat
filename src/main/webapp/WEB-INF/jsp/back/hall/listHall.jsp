...
<head>
    ...
    <script>
      ...
      function toEdit(id) {
        window.location.href = "hall/toEditHall?id=" + id;
      }

      function toAdd() {
        window.location.href = "hall/toAddHall";
      }
    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <button onclick="toAdd()">添加影厅</button>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
                            ...
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${hallList}" var="hallList">
                                    <tr>
                                        ...
                                        <td><span>${hallList.cinemaname}</span></td>
                                        <td><span>${hallList.hallname}</span></td>
                                        <td><span>${hallList.seatrows}</span></td>
                                        <td><span>${hallList.seatcols}</span></td>
                                        <td><span>${hallList.type}</span></td>
                                        <td>
                                            <div class="">
                                                <button class="green" onclick="toEdit(${hallList.id})">
                                                    <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                    编辑影厅
                                                </button>

                                                <button class="red" onclick="del(${hallList.id})">
