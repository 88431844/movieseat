...
<head>
    ...
    <script>
      ...
      function back() {
        window.location.href = "hall/listHall";
      }
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="hall/editHall"
                              method="post" id="hall">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" readonly="" value="${hall.cinemaname}" placeholder="电影名称"
                                           class="col-xs-10 col-sm-5"/>
                                    <input type="hidden" name="cinemaid" value="${hall.cinemaid}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="hallname" value="${hall.hallname}" placeholder="影厅名称"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="seatrows" class="input-mini spinner-input form-control"
                                           value="${hall.seatrows}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="seatcols" class="input-mini spinner-input form-control"
                                           value="${hall.seatcols}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="type" id="type">
                                        <option value="${hall.type}">*${hall.type}</option>
                            ...
                            <input type="hidden" name="oldHallName" value="${hall.hallname}">
                            <input type="hidden" name="oldCinemaId" value="${hall.cinemaid}">
                        </form>
