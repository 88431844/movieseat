...
<head>
    ...
    <script>
        function add() {
            var form = document.getElementById('hall');
            form.submit();
        }
    </script>
</head>
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="hall/addHall"
                               method="post" id="hall">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 座位排数 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="seatrows" readonly=""  class="input-mini spinner-input form-control" id="spinner3" maxlength="3">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 座位列数 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="seatcols" readonly="" class="input-mini spinner-input form-control" id="spinner4" maxlength="3">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 影厅类型 </label>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $('#spinner3').ace_spinner({value:10,min:10,max:20,step:2, on_sides: true, icon_up:'ace-icon fa fa-plus smaller-75', icon_down:'ace-icon fa fa-minus smaller-75', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
        $('#spinner4').ace_spinner({value:20,min:10,max:30,step:2, on_sides: true, icon_up:'ace-icon fa fa-plus smaller-75', icon_down:'ace-icon fa fa-minus smaller-75', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
