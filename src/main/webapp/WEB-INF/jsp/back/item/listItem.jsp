    ...
    <script>
        function del(id) {
          ...
          if (null != adminUserRoleStr && !"".endsWith(adminUserRoleStr) && "1".endsWith(adminUserRoleStr)) {
            ...
            if (confirm('您确定删除吗？')) {
                window.location.href = "item/delItem?id=" + id;
            }
        }

        function toEdit(id) {
            window.location.href = "item/toEditItem?id=" + id;
        }

        function toAdd() {
            window.location.href = "item/toAddItem";
        }
    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <button onclick="toAdd()">添加物品</button>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
                        ...
                        <div>
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <button class="green" onclick="toEdit(${itemList.id})">
                                                <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                编辑
                                            </button>

                                            <button class="red" onclick="del(${itemList.id})">
