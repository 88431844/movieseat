        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="item/addItem"
                              enctype="multipart/form-data" method="post" id="itemInfo">
                            <!-- #section:elements.form -->
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 物品名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="name" placeholder="物品名称" class=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="cost" placeholder="消耗积分" class=""/>
                                </div>
                            </div>
                            <div class="form-group">
