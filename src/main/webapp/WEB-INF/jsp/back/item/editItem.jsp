        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="item/editItem"
                              method="post" id="itemInfo">
                            <!-- #section:elements.form -->
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 物品名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="name" value="${itemInfo.name}" placeholder="物品名称"
                            ...
                            <input type="hidden" name="oldName" value="${itemInfo.name}">
                        </form>
