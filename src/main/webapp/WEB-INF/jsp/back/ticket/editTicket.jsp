...
<head>
    ...
    <script>
      ...
      function back() {
        window.location.href = "ticket/listTicket";
      }
    </script>
</head>
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="ticket/editTicket"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" readonly="" value="${ticketDto.movieName}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" readonly="" value="${ticketDto.cinemaName}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input id="timepicker1" readonly="" value="${ticketDto.time}" type="text" name="time" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="type" id="type">
                                        <option value="${ticketDto.type}">*${ticketDto.type}</option>
                            ...
                            <input type="hidden" name="id" value="${ticketDto.id}">
                        </form>
