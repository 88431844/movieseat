                    ...
                    <div class="col-xs-12">
                        ...
                        <%--<div class="row">--%>
                            ...
                            <%--&lt;%&ndash;<div class="col-sm-7">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-box">&ndash;%&gt;&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-header">&ndash;%&gt;&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;&lt;%&ndash;<h4 class="widget-title">Inline Forms</h4>&ndash;%&gt;&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;&lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;--%>

                                    <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-body">&ndash;%&gt;&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-main">&ndash;%&gt;&ndash;%&gt;--%>
                                            <%--&lt;%&ndash;&lt;%&ndash;<form class="form-inline">&ndash;%&gt;&ndash;%&gt;--%>
                                                <%--&lt;%&ndash;&lt;%&ndash;<input type="text" class="input-small" placeholder="Username" />&ndash;%&gt;&ndash;%&gt;--%>
                                                <%--&lt;%&ndash;&lt;%&ndash;<input type="password" class="input-small" placeholder="Password" />&ndash;%&gt;&ndash;%&gt;--%>
                                                <%--&lt;%&ndash;&lt;%&ndash;<label class="inline">&ndash;%&gt;&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;&lt;%&ndash;<input type="checkbox" class="ace" />&ndash;%&gt;&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;&lt;%&ndash;<span class="lbl"> remember me</span>&ndash;%&gt;&ndash;%&gt;--%>
                                                <%--&lt;%&ndash;&lt;%&ndash;</label>&ndash;%&gt;&ndash;%&gt;--%>

                                                <%--&lt;%&ndash;&lt;%&ndash;<button type="button" class="btn btn-info btn-sm">&ndash;%&gt;&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;&lt;%&ndash;<i class="ace-icon fa fa-key bigger-110"></i>Login&ndash;%&gt;&ndash;%&gt;--%>
                                ...
                                <%--&lt;%&ndash;<div class="widget-box">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-header widget-header-small">&ndash;%&gt;&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;&lt;%&ndash;<h5 class="widget-title lighter">Search Form</h5>&ndash;%&gt;&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;&lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;--%>

                                    <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-body">&ndash;%&gt;&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;&lt;%&ndash;<div class="widget-main">&ndash;%&gt;&ndash;%&gt;--%>
                                            <%--&lt;%&ndash;&lt;%&ndash;<form class="form-search">&ndash;%&gt;&ndash;%&gt;--%>
                                                <%--&lt;%&ndash;&lt;%&ndash;<div class="row">&ndash;%&gt;&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;&lt;%&ndash;<div class="col-xs-12 col-sm-8">&ndash;%&gt;&ndash;%&gt;--%>
                                                        <%--&lt;%&ndash;&lt;%&ndash;<div class="input-group">&ndash;%&gt;&ndash;%&gt;--%>
                                                            <%--&lt;%&ndash;&lt;%&ndash;<input type="text" class="form-control search-query" placeholder="Type your query" />&ndash;%&gt;&ndash;%&gt;--%>
                                                            <%--&lt;%&ndash;&lt;%&ndash;<span class="input-group-btn">&ndash;%&gt;&ndash;%&gt;--%>
																		<%--&lt;%&ndash;&lt;%&ndash;<button type="button" class="btn btn-purple btn-sm">&ndash;%&gt;&ndash;%&gt;--%>
																			<%--&lt;%&ndash;&lt;%&ndash;Search&ndash;%&gt;&ndash;%&gt;--%>
																			<%--&lt;%&ndash;&lt;%&ndash;<i class="ace-icon fa fa-search icon-on-right bigger-110"></i>&ndash;%&gt;&ndash;%&gt;--%>
																		<%--&lt;%&ndash;&lt;%&ndash;</button>&ndash;%&gt;&ndash;%&gt;--%>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            widget-header widget-header-small                        </div>
                                    </div>
