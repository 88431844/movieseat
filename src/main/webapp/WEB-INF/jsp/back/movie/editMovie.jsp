...
<head>
    ...
    <script>
        ...
        function back() {
            window.location.href = "backMovie/listMovie";
        }
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="backMovie/editMovie"
                              method="post" id="movieInfo">
                            <!-- #section:elements.form -->
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"> 电影名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" name="name" value="${movieInfo.name}" placeholder="电影名称"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="director" value="${movieInfo.director}" placeholder="导演"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="screenwriter" value="${movieInfo.screenwriter}"
                                           placeholder="编剧" class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="starring" value="${movieInfo.starring}" placeholder="主演"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="type">
                                        <option value="${movieInfo.type}">*${movieInfo.type}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="language" id="language">
                                        <option value="${movieInfo.language}">*${movieInfo.language}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="length" value="${movieInfo.length}" placeholder="片长"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
