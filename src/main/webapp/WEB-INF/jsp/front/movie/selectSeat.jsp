                    ...
                    <div class="alert alert-info bigger-110">
                        ...
                        <script>
                            ...
                            <%
                               ...
                               if (null != cardInfoDto){
                                   if (null != cardInfoDto.getDiscount() && 0 != cardInfoDto.getDiscount()){
                                       double userDiscount = cardInfoDto.getDiscount();
                                      out.print("var discount = "+ userDiscount/ 10+";");
                                      out.print("var cardName = '"+ cardInfoDto.getName()+"';");
                                      out.print("document.getElementById(\"totalPrice\").innerHTML = cardName + discount *10 +\"折，共计：\"+totalPrice * discount + \" 元\";");
                                   }
                               }else {
                                   out.print("var discount = 1;");
                                   out.print("document.getElementById(\"totalPrice\").innerHTML = \"共计：\"+totalPrice + \" 元\";");
                               }
                           %>
                        </script>
                        <span><span id="totalPrice"></span>
                        </span>
