...
<head>
    ...
    <script>
        function buy(id, cost) {
            ...
            if (confirm('您确定兑换吗？')) {
                window.location.href = "shop/buyItem?id=" + id;
            }
        }
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                <li>
                    ...
                    <span>积分商城-->我的积分：<span id="integral">${integral}</span></span>
                </li>
                <li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${itemInfoDtoList}" var="itemInfoDtoList">
                                    <tr>
                                        <td><span>${itemInfoDtoList.name}</span></td>
                                        <td><span>${itemInfoDtoList.cost}</span></td>
                                        <td><span>${itemInfoDtoList.itemdesc}</span></td>
                                        <td>
                                            <div class="">
                                                <button class="green"
                                                        onclick="buy(${itemInfoDtoList.id},${itemInfoDtoList.cost})">
