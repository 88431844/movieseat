...
<head>
    ...
    <script>
        function buy(id) {
            if (confirm('您确定购买吗？')) {
                window.location.href = "card/buyCard?id=" + id;
            }
        }
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${cardInfoDtoList}" var="cardInfoDtoList">
                                    <tr>
                                        <td><span>${cardInfoDtoList.name}</span></td>
                                        <td><span>${cardInfoDtoList.price}</span></td>
                                        <td><span>${cardInfoDtoList.carddesc}</span></td>
                                        <td><span>${cardInfoDtoList.discount}</span></td>
                                        <td>
                                            <div class="">
                                                <button class="green"
                                                        onclick="buy(${cardInfoDtoList.id})">
