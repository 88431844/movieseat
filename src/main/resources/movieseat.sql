...
CREATE TABLE `hall` (
  ...
  `hallname` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '影厅名称',
  `seatrows` int(11) DEFAULT NULL COMMENT '影厅排数',
  `seatcols` int(11) DEFAULT NULL COMMENT '影厅列数',
  `type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '影厅类型（3D等）',
  PRIMARY KEY (`id`)
...
-- Records of iteminfo
-- ----------------------------
INSERT INTO `iteminfo` VALUES ('3', '1', null, '1', '1');
INSERT INTO `iteminfo` VALUES ('4', '2', null, '2', '2');
INSERT INTO `iteminfo` VALUES ('5', '3', null, '3', '300');
...
-- Records of muser
-- ----------------------------
INSERT INTO `muser` VALUES ('1', 'luck', 'luck', '醉家男煮饺', '15840505894', '0', '123', null);
...
-- Records of seat
-- ----------------------------
INSERT INTO `seat` VALUES ('6', '5', '8', '3', '1');
INSERT INTO `seat` VALUES ('7', '5', '9', '3', '1');
INSERT INTO `seat` VALUES ('8', '4', '8', '3', '1');
...
-- Records of ticket
-- ----------------------------
INSERT INTO `ticket` VALUES ('1', '11', '2', '7', '2019-04-15', '20:10', '33', '2D', '100');
INSERT INTO `ticket` VALUES ('2', '3', '2', '6', '2019-04-09', '19:00', '55', '3D', '100');
INSERT INTO `ticket` VALUES ('3', '7', '2', '5', '2019-05-08', '20:00', '44', '3D', '110');
